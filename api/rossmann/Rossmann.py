...
class Rossmann(object):
    def __init__(self):
        self.home_path = '/home/marcos/Documentos/comunidade_DS/DataScience_em_Producao/DataScience_Em_Producao/marcos/'
    ...
    def data_preparation(self, df5):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'competition_distance',
                                ...
                                'promo2_since_year', 'promo_time_week', 'day_sin', 'day_cos', 'day_of_week_sin',
                                'day_of_week_cos']
